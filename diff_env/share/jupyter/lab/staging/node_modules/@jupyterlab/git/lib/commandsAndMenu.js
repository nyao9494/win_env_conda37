 ...
 */
export function addCommands(app, model, fileBrowser, settings, renderMime) {
    ...
    commands.addCommand(CommandIDs.gitClone, {
        ...
        execute: async () => {
            ...
            if (result.button.accept && result.value) {
                ...
                try {
                    await Private.showGitOperationDialog(model, Operation.Clone, { path: fileBrowser.model.path, url: result.value });
                    logger.log({
