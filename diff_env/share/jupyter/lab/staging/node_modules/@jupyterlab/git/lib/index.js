 ...
 */
async function activate(app, mainMenu, restorer, factory, renderMime, settingRegistry, docmanager, statusBar) {
    ...
    if (settings) {
        ...
        addCommands(app, gitExtension, factory.defaultBrowser, settings, renderMime);
