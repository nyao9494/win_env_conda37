    ...
    render() {
        ...
        return (React.createElement(Portal, null,
            React.createElement(Snackbar, { key: "git:alert", open: this.props.open, anchorOrigin: {
                ...
                React.createElement(MuiAlert, { action: this.props.error && (React.createElement(Button, { color: "inherit", size: "small", onClick: () => {
                            showErrorMessage('Error', this.props.error);
                        } }, "SHOW")), variant: "filled", severity: severity }, this.props.message || '(missing message)'))));
    }
}
