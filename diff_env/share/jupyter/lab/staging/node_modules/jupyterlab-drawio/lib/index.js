...
import { DrawioFactory } from './editor';
/**
 * The name of the factory that creates editor widgets.
 */
const FACTORY = 'Drawio';
export const IDrawioTracker = new Token('drawio/tracki');
/**
...
function activate(app, browserFactory, restorer, menu, palette, launcher) {
    ...
    const createNewSVG = (cwd) => {
        return commands.execute('docmanager:new-untitled', {
            path: cwd, type: 'file', ext: '.svg'
        }).then(model => {
            let wdg = app.shell.currentWidget;
