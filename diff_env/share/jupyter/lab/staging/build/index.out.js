...
function main() {
  ...
  try {
    extMod = require('jupyterlab-drawio/');
    extension = extMod.default;
  ...
  try {
    extMod = require('@jupyterlab/toc/lib/extension.js');
    extension = extMod.default;
  ...
  try {
    extMod = require('@lckr/jupyterlab_variableinspector/');
    extension = extMod.default;
  ...
  try {
    extMod = require('nbdime-jupyterlab/');
    extension = extMod.default;
