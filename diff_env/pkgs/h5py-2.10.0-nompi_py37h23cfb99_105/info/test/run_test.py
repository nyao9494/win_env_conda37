#  tests for h5py-2.10.0-nompi_py37h23cfb99_105 (this is a generated file);
print('===== testing package: h5py-2.10.0-nompi_py37h23cfb99_105 =====');
...
print('===== h5py-2.10.0-nompi_py37h23cfb99_105 OK =====');
print("import: 'h5py'")
import h5py
