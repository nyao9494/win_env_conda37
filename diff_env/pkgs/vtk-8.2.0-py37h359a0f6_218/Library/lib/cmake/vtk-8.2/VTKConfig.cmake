...
set(_vtk_installed_prefix "D:/bld/vtk_1590750225115/_h_env/Library/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "D:/bld/vtk_1590750225115/_h_env/Library")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/bld/vtk_1590750225115/_h_env/Library/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/bld/vtk_1590750225115/_h_env/Library/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/bld/vtk_1590750225115/work/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/bld/vtk_1590750225115/work/build/lib")
  endif ()
endif()
