...
if(NOT "${Boost_USE_MULTITHREADED}" STREQUAL "" AND NOT Boost_USE_MULTITHREADED)
  _BOOST_SKIPPED("boost_wave.lib" "multithreaded, Boost_USE_MULTITHREADED=${Boost_USE_MULTITHREADED}")
  return()
endif()
...
if(__boost_imploc)
  message(WARNING "Target Boost::wave already has an imported location '${__boost_imploc}', which will be overwritten with '${_BOOST_LIBDIR}/boost_wave.lib'")
endif()
...
set_target_properties(Boost::wave PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_BOOST_LIBDIR}/boost_wave.lib"
  )
