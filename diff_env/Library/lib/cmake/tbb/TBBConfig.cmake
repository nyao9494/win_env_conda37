...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    get_filename_component(_tbb_release_lib "${CMAKE_CURRENT_LIST_DIR}/../../../bin/${_tbb_component}.dll" ABSOLUTE)

    if (NOT TBB_FIND_RELEASE_ONLY)
        get_filename_component(_tbb_debug_lib "${CMAKE_CURRENT_LIST_DIR}/../../../bin/${_tbb_component}_debug.dll" ABSOLUTE)
    endif()
        ...
        if (NOT TARGET TBB::${_tbb_component})
            ...
            if (EXISTS "${_tbb_release_lib}")
                set_target_properties(TBB::${_tbb_component} PROPERTIES
                                      ...
                                      IMPORTED_IMPLIB_RELEASE "${CMAKE_CURRENT_LIST_DIR}/../../${_tbb_component}.lib")
            ...
            if (EXISTS "${_tbb_debug_lib}")
                set_target_properties(TBB::${_tbb_component} PROPERTIES
                                      ...
                                      IMPORTED_IMPLIB_DEBUG "${CMAKE_CURRENT_LIST_DIR}/../../${_tbb_component}_debug.lib")
